...
namespace Swh\SymfonyDebug\Command;

use Swh\SymfonyDebug\Console\Helper\DescriptorHelper;
 ...
 * @internal
 *
 * @see \Symfony\Bundle\FrameworkBundle\Command\ContainerDebugCommand
 */
#[AsCommand(name: 'debug:container', description: 'Display current services for an application')]
class ContainerDebugCommand extends Command
{
    public function __construct(
        private readonly ContainerBuilderDebugger $containerBuilder,
    ){
        parent::__construct();
    }
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $options['output'] = $io;
        $options['is_debug'] = $input->getOption('debug');
    ...
    {
        return $this->containerBuilder->getBuilder();
    }
}
